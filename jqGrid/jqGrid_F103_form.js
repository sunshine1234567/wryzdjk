...
var F103_form_height = $('.F5-form').height()-80;
/*var overhiddenBoxHeight = (F4_form_height + 80) + 'px';
$(".overhiddenBox").css({"height":overhiddenBoxHeight});*/
$("#F103-form").jqGrid({
    url: '',
    datatype: function (data) {
        var thegrid = jQuery("#F103-form")[0];
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            + '{"ctn1":"1","ctn2":"<a>唐山瑞斯集团</a>","ctn3":"唐山瑞斯集团污水处理工程","ctn4":"薛晓慧","ctn5":"2016-10-12 10:00:00","ctn6":"<a>预览</a> &nbsp;&nbsp;&nbsp;<a>下载</a>"}'
            + "]})");
    ...
    colModel: [
        ...
        { label: '企业', name: 'ctn2', align: "center", width:30 },
        { label: '验收资料名称', name: 'ctn3', align: "center", width: 20 },
    ...
    viewrecords: true,
    width:1050,
    height: F103_form_height,
    rowNum: 20,
    rowList: [20,50,100],
    shrinkToFit: true,
    pager: "#F103-form-pager"
});
