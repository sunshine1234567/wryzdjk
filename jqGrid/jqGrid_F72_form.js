...
var F72_form_width = $('.F5-form').width()+20;
var F72_form_height = $('.F5-form').height();
/*var overhiddenBoxHeight = (F4_form_height + 80) + 'px';
 $(".overhiddenBox").css({"height":overhiddenBoxHeight});*/
$("#F72-form").jqGrid({
    url: '',
    datatype: function (data) {
        var thegrid = jQuery("#F72-form")[0];
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            ...
            +',{"方格1":"<b>监测数据</b>","方格2":"氨氮","方格3":"<div class=\'bgf7\'>11.009 m3/s</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"工作状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"故障信息","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            + "]})");
    ...
    viewrecords: true,
    width: F72_form_width,
    height: F72_form_height,
    rowNum: 20,
    rowList: [20,50,100],
   // shrinkToFit: true,
   // pager: "#F72-form-pager",
    shrinkToFit: true,
    gridview: true,
    /* rownumbers: true,*/
    sortname: 'invdate',
