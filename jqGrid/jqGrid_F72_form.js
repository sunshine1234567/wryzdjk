...
var F72_form_height = $('.F5-form').height()-125;
...
$("#F72-form").jqGrid({
    ...
    datatype: function (data) {
        ...
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            ...
            +',{"方格1":"监测数据","方格2":"氨氮","方格3":"<div class=\'bgf7\'>11.009 m3/s</div>"}'
            +',{"方格1":"运行状态","方格2":"工作状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            +',{"方格1":"运行状态","方格2":"故障信息","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            + "]})");
