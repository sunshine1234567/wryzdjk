...
$("#F7-form").jqGrid({
    ...
    datatype: function (data) {
        ...
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            ...
            +',{"方格1":"<b>监测数据</b>","方格2":"废气流量","方格3":"<div class=\'bgf7\'>11.009 m3/s</div>"}'
            +',{"方格1":"<b>监测数据</b>","方格2":"二氧化硫","方格3":"<div class=\'bgf7\'>24.948 mg/m3</div>"}'
            +',{"方格1":"<b>监测数据</b>","方格2":"氮氧化物","方格3":"<div class=\'bgf7\'>24.948 mg/m3</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"供电状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"在线状态","方格3":"<div class=\'bgf7 icongreen\'>离线</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"内核状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"信号状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            +',{"方格1":"<b>运行状态</b>","方格2":"仪器通讯状态","方格3":"<div class=\'bgf7 icongreen\'>正常</div>"}'
            + "]})");
