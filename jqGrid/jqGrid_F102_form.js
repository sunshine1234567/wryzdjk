...
var F102_form_height = $('.F5-form').height()-80;
/*var overhiddenBoxHeight = (F4_form_height + 80) + 'px';
$(".overhiddenBox").css({"height":overhiddenBoxHeight});*/
$("#F102-form").jqGrid({
    url: '',
    datatype: function (data) {
        var thegrid = jQuery("#F102-form")[0];
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            + '{"ctn1":"1","ctn2":"<a>唐山瑞斯集团</a>","ctn3":"2016年排污许可证","ctn4":"薛晓慧","ctn5":"2016-10-12 10:00:00","ctn6":"<a>预览</a> &nbsp;&nbsp;&nbsp;<a>下载</a>"}'
            + "]})");
    ...
    colModel: [
        ...
        { label: '排污许可证名称', name: 'ctn3', align: "center", width: 20 },
    ...
    viewrecords: true,
    width:1050,
    height: F102_form_height,
    rowNum: 20,
    rowList: [20,50,100],
    shrinkToFit: true,
    pager: "#F102-form-pager"
});
